...
const RegisterReducer = (state = { phone_number: undefined, phone_with_code: undefined, country_code: undefined, first_name: undefined, last_name: undefined, email: undefined }, action) => {
    switch (action.type) {
