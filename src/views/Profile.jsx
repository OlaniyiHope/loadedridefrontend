...
import { bold, regular, api_url, get_profile, profile_picture_upload, profile_picture_update, img_url, f_xl, f_xs, f_m, f_l, normal } from '../config/Constants';
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: regular }}>Edit Profile</Text>
                </View>
            </View>
            <ScrollView>
                {on_load == 1 &&
                    <View>
                        ...
                        <ScrollView>
                            <View style={{ alignItems: 'center' }}>
                                <Text style={{ color: colors.theme_fg_two, fontSize: f_l, fontFamily: regular }}>Say a little bit about yourself...</Text>
                                <View style={{ margin: 20 }} />
                                <View style={{ width: '90%' }}>
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: normal }}>First Name</Text>
                                        <View style={{ margin: 5 }} />
                                    ...
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: normal }}>Last Name</Text>
                                        <View style={{ margin: 5 }} />
                                    ...
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: normal }}>Email</Text>
                                        <View style={{ margin: 5 }} />
                                    ...
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: normal }}>Phone Number</Text>
                                        <View style={{ margin: 5 }} />
