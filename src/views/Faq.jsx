...
import { normal, bold, api_url, faq, maxHeaderHeight, minHeaderHeight, f_s, f_xl, f_30, regular } from '../config/Constants';
        ...
        <View style={styles.container}>
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: regular }}>Faq</Text>
                </View>
            </View>
            <FlatList
            data={data}
