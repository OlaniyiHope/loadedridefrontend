...
import { normal, bold, regular, logo, maxHeaderHeight, minHeaderHeight, api_url, sos_contact_list, delete_sos_contact, add_contact, loader, f_l, f_s, f_m, f_xl, f_30, call_admin, call_ambulance, call_police, f_xs, f_25 } from '../config/Constants';
        ...
        return (
            <View style={styles.animationHeader}>
                ...
                <View style={{ padding: 30, alignItems: 'center' }}>
                    <Text numberOfLines={2} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_25, letterSpacing: 1, fontFamily: regular, textAlign: 'center' }}>Setup Emergency Contacts</Text>
                </View>
            </View>
        )
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ padding: 10 }}>
                <TouchableOpacity onPress={navigate_safety_contact.bind(this)} activeOpacity={1} style={{ width: '100%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                    <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontFamily: bold }}>Safety</Text>
                </TouchableOpacity>
            </View>
            <View style={{ padding: 10 }}>
