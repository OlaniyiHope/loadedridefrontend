            ...
            <View style={styles.animationHeader}>
                ...
                <View style={{ padding: 10, flexDirection: 'row' }}>
                    <View style={{ width: '70%', alignItems: 'flex-start', justifyContent: 'center' }}>
                        <Text numberOfLines={2} ellipsizeMode='tail' style={{ paddingLeft: 17, color: colors.theme_fg_three, fontSize: f_30, letterSpacing: 1, fontFamily: regular }}>How can we help you?</Text>
                    </View>
