...
import { normal, bold, screenWidth, f_s, f_25, register, regular } from '../config/Constants';
  ...
  const slides = [
    {
      key: 1,
      title: 'Search A Car',
      text: 'You can choose the vehicle model and bid your own fare for that ride based on your needs and the number of passengers.',
    ...
    },
    {
      ...
      text: 'Have a pleasant ride and arrive at your destination on time and within your own fare by bidding.',
