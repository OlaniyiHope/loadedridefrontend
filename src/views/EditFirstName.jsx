...
import { normal, bold, regular, profile_update, api_url, btn_loader, f_xl, f_xs, f_m, logo } from '../config/Constants';
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: regular }}>Enter your first name</Text>
                <View style={{ margin: 5 }} />
                ...
                <View style={{ width: '80%' }}>
                    ...
                    {loading == false ?
                        <TouchableOpacity onPress={check_valid.bind(this)} activeOpacity={1} style={{ width: '100%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontFamily: normal }}>Done</Text>
                        </TouchableOpacity>
                        :
