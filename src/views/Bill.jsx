                ...
                <ScrollView>
                    <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_bg, padding: 20, flexDirection: 'row' }}>
                        ...
                        <View style={{ width: '90%', alignItems: 'center', justifyContent: 'center' }}>
                            <Text numberOfLines={1} style={{ color: colors.theme_fg_three, fontSize: f_25, fontFamily: regular }}><Text style={{ fontFamily: regular }}>{app_name}</Text> Receipt</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ padding: 20 }}>
                        ...
                        <View style={{ margin: 5 }} />
                        <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: regular }}>{data.vehicle_type} | {data.distance} km</Text>
                        <View>
